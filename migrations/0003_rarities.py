...
class Migration(Migration):
    dependencies = [("models", "0002_adjust_columns")]

    operations = [
        RunSQL(
            sql="""UPDATE "thiagachaitems" SET "rarity" = '1' WHERE "rarity" = 'COMMON';
            ...
            reverse_sql="""ALTER TABLE "thianames" DROP COLUMN "gacha_uncommon_name";
