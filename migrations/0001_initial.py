...
class Migration(Migration):
    ...
    operations = [RunSQL(sql="""
        ...
        CREATE TABLE IF NOT EXISTS "thiadicenetry" (
            ...
            "name" TEXT NOT NULL,
            "value" TEXT NOT NULL,
            "guild_id" BIGINT NOT NULL REFERENCES "thiadiceconfig" ("guild_id") ON DELETE CASCADE
        );
        ...
        CREATE TABLE IF NOT EXISTS "thiagachaitems" (
            ...
            "guild_id" BIGINT NOT NULL REFERENCES "thiagachaconfig" ("guild_id") ON DELETE CASCADE
        );
        ...
        CREATE TABLE IF NOT EXISTS "thiaitemssystemitems" (
            ...
            "guild_id" BIGINT NOT NULL REFERENCES "thiaitemsconfig" ("guild_id") ON DELETE CASCADE
        );
        ...
        CREATE TABLE IF NOT EXISTS "thiamessagelink" (
            ...
            "guild_id" BIGINT NOT NULL REFERENCES "thiamessageconfig" ("guild_id") ON DELETE CASCADE
        );
